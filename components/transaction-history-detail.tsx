...
export function TransactionHistoryDetail({
  ...
  if (!record) {
    return (
      <div className="rounded-2xl border border-dashed border-zinc-200 bg-zinc-50/60 p-8 text-center text-sm text-zinc-500">
    ...
    >
      ...
      <dl className="mt-6 space-y-5">
        ...
        <div>
          ...
          <dd className="mt-1 text-sm font-medium text-zinc-900">{prettyAmount}</dd>
        </div>
        <div>
